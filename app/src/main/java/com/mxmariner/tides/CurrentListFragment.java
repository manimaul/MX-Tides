...
//	public static final String TAG = "CURRENTS";
...
//		final ArrayList<Station> subList = ma.getStationSubList(Station.TYPE_CURRENT);
...
//
//		final MainActivity ma = ((MainActivity) getActivity());
//		ma.setSelectedStation(ma.getCurrStationSubList().get(position));
//		ma.goToStationTab();
//	}
//
